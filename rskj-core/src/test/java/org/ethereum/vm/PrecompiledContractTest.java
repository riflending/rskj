...
public class PrecompiledContractTest {
    ...
    @Test
    @Ignore("blake2fTestVector8: This test takes a lot of time to be executed (up to 15 minutes)")
    ...
    private void internalBlake2fTestVector(String data, String expected) {
        byte[] resultBytes = callBlake2(data);

        assertEquals(expected, Hex.toHexString(resultBytes));
    }
    ...
    private byte[] callBlake2(String data) {
        ...
        return contract.execute(dataBytes);
    }
