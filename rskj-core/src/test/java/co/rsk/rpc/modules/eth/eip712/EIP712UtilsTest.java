...
public class EIP712UtilsTest {
    ...
    public void typedDataEncodesOk() {
        assertThat(
                Hex.toHexString(utils.eip712EncodeV4(typedData)),
    ...
    public void rec_typedDataEncodesOk() {
        assertThat(
                Hex.toHexString(utils.eip712EncodeV4(recTypedData)),
    ...
    public void relayRequest_typedDataEncodesOk() {
        assertThat(
                Hex.toHexString(utils.eip712EncodeV4(relayRequest)),
    ...
    public void funnyRequest_doesNotThrow() {
        ...
        utils.eip712EncodeV4(funnyRequest);
    }
